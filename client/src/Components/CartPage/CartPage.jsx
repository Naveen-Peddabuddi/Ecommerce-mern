        ...
        data.length !== 0 ?
          <div className='CartPage'>
...

            {
              data.map((e) => (
                <div className='CartProdHeading IndividualProdCart'>
                  <div onClick={() => {navigate(`/${e.tag}/${e._id}`) }} ><img src={e.images[0]} alt="" /></div>
                  <div onClick={() => {navigate(`/${e.tag}/${e._id}`) }} ><p>{e.name}</p></div>
            ...
            <div className='Checkout'>
              <button class="hbtn hb-fill-right-br" onClick={() => navigate("/")}><p>Continue Shopping</p></button>
              <button class="hbtn hb-fill-right-br" onClick={() => navigate("/contact")}><p>Proceed to checkout</p></button>
            </div>
